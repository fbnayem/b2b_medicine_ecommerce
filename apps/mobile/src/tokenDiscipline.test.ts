...
const RAW_HEX: readonly string[] = [
  ...
  'app/(protected)/(tabs)/approvals.tsx',
  'app/(protected)/(tabs)/cart.tsx',
  'app/(protected)/(tabs)/deliveries.tsx',
  'app/(protected)/(tabs)/finance-dashboard.tsx',
  'app/(protected)/(tabs)/fulfilment.tsx',
  'app/(protected)/(tabs)/inventory.tsx',
  'app/(protected)/(tabs)/medicines.tsx',
  'app/(protected)/(tabs)/notifications.tsx',
  'app/(protected)/(tabs)/orders.tsx',
  'app/(protected)/(tabs)/ready.tsx',
  'app/(protected)/(tabs)/returns.tsx',
  'app/(protected)/(tabs)/security.tsx',
  'app/(protected)/(tabs)/system-settings.tsx',
  'app/(protected)/approval-review.tsx',
  'app/(protected)/checkout.tsx',
  'app/(protected)/collection-review.tsx',
  'app/(protected)/collections.tsx',
  'app/(protected)/delivery-detail.tsx',
  'app/(protected)/delivery-proof.tsx',
  'app/(protected)/invoices.tsx',
  'app/(protected)/medicine-detail.tsx',
  'app/(protected)/notification-preferences.tsx',
  'app/(protected)/order-detail.tsx',
  'app/(protected)/overdue-shops.tsx',
  'app/(protected)/payment-detail.tsx',
  'app/(protected)/payments.tsx',
  'app/(protected)/picking.tsx',
  'app/(protected)/return-detail.tsx',
  'app/(protected)/statement.tsx',
  'src/finance/components.tsx',
  'src/notifications/ActivityTimelineView.tsx',
