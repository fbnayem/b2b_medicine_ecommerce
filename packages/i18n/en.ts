...
export const en = {
  ...
  orders: {
    ...
    reorderReady: 'These are in your order. Check the quantities before you send it.',
    reorderFailed: 'These could not be put back in your order.',
    viewInvoice: 'See the invoice',
    cancelReasonHint: 'At least {{minimum}} characters, so a manager can act on it.',
    cancelReasonTooLong: 'Keep it under {{maximum}} characters.',
    cancelAsked: 'Asked. A manager will decide, and you will be told.',
    cancelFailed: 'That request could not be sent.',
  },
  ...
  shops: {
    ...
    oldestDue: 'Oldest unpaid since',
    creditBlocked: 'Credit is blocked — this customer cannot order on credit',
    openLedger: 'Open the account',
    openStatement: 'Open the statement',
    reinstate: 'Reinstate this customer',
    reinstateTitle: 'Reinstate this customer?',
    reinstateBody: 'They can place orders again from the moment you confirm.',
    reinstateConfirm: 'Reinstate them',
    reinstated: 'The customer can order again.',
    suspendConfirm: 'Suspend them',
    suspended: 'The customer has been suspended.',
    ledgerLoading: 'Loading the account',
    ledgerCouldNotLoad: 'This account could not be loaded.',
    stillOpen: 'Still open',
    everyMovement: 'Every movement',
    nothingOpen: 'Nothing is outstanding.',
    noMovements: 'No movements in this account yet.',
    charged: 'Charged',
    paid: 'Paid',
  ...
  finance: {
    ...
    couldNotLoadInvoice: 'This invoice could not be loaded.',
    loadingInvoice: 'Opening the invoice',
    forOrder: 'For order',
    whatWasDelivered: 'What was delivered',
    batchAndExpiry: 'Batch {{batch}} · expires {{expiry}}',
    quantityAtPrice: '{{quantity}} at {{price}}',
    whatItCame: 'What it came to',
    grandTotal: 'Total',
    paid: 'Paid',
    seeStatement: 'See your account',
    cancelledInvoice: 'This invoice has been cancelled.',
    issued: 'Issued',
    dueOnDate: 'Due',
    totalAmount: 'Total',
    paidAmount: 'Paid',
  ...
  delivery: {
    ...
    notDispatched: 'It has not left us yet',
    nothingComing: 'Nothing is on its way',
    nothingComingBody:
      'Once an order has been packed and given to somebody to bring, it appears here.',
    notDispatchedBody:
      'This order is still being prepared. Once somebody is bringing it, you will see who, and how far they have got.',
    whoIsBringingIt: 'Who is bringing it',
    rider: 'Delivery person',
    riderNotAssigned: 'Nobody has been given this yet.',
    progress: 'How far it has got',
    noProgressYet: 'Nothing has happened yet.',
    delivered: 'Delivered',
  ...
  priceLists: {
    create: 'Create a price list',
    created: '{{name}} created.',
    createFailed: 'That price list could not be created.',
    newTitle: 'Create a price list',
    newSubtitle: 'Give it a name. Prices are added to it one line at a time.',
    nameRequired: 'Give the list a name.',
    openList: 'Open {{name}}',
    shopsPriced: 'Customers priced from it',
    notInUse: 'Not in use',
    loadingOne: 'Loading this price list',
    couldNotLoadOne: 'This price list could not be loaded.',
    findLine: 'Find a medicine',
    findLineHint: 'Type at least two letters. Lines already on this list come first.',
    changePrice: 'Change this price',
    changePriceFor: 'Change the price of {{brand}}',
    priceTaka: 'Price each, in taka',
    priceHint: 'What a customer on this list pays for one unit. Zero is allowed.',
    savePrice: 'Save this price',
    noLines: 'Nothing is priced on this list yet',
    noLinesBody: 'Search for a medicine above and give it a price.',
    priceRequired: 'Type a price. Zero is allowed.',
    priceTooLarge: 'That is larger than a price can be. Check the figure.',
    title: 'Price lists',
    subtitle:
  ...
  schemes: {
    ...
    created: '{{name}} created.',
    openScheme: 'Open {{name}}',
    notInUse: 'Not in use',
    appliesTo: 'Applies to',
    until: 'Until',
    loadingOne: 'Loading this offer',
    couldNotLoadOne: 'This offer could not be loaded.',
    newTitle: 'Create a free-goods offer',
    buyHint: 'How many they have to buy.',
    freeHint: 'How many they get on top, at no charge.',
    buyRequired: 'How many must they buy? A whole number, at least one.',
    freeRequired: 'How many do they get free? A whole number, at least one.',
    moreFreeThanBought:
      'That gives away more than is bought. Check the two numbers — free goods never appear in the money, so this would ship unnoticed.',
    needNameAndMedicine: 'Give the offer a name and choose a medicine.',
    changeTitle: 'Change this offer?',
    changeBody:
      'It applies from now on. Orders already placed keep the terms they were given — this does not restate them.',
    changeConfirm: 'Change it',
    pastOrdersKeepTerms: 'Orders already placed keep the terms they were given.',
